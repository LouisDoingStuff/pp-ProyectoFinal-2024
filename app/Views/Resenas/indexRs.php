...
<h3 class="my-3" id="titulo">RESEÑAS</h3>
            ...
            <a href="<?= base_url('nueva_rs') ?>" class="btn btn-success">Agregar</a>
            ...
            <table class="table table-hover table-bordered my-3" id="dataTable" aria-describedby="titulo">
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?= base_url('eliminar_rs/' . $resena->id_resena); ?>" class="btn btn-danger">Eliminar</a>
                        <a href="<?= base_url('buscar_rs/' . $resena->id_resena); ?>" class="btn btn-info">Modificar</a>
                    </td>
